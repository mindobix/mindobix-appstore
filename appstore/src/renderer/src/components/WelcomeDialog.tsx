      ...
      <div className="w-full max-w-md bg-[#1a1a2e] rounded-2xl border border-white/10 shadow-2xl overflow-hidden">
        ...
        <div className="px-8 pb-8">
          ...
          <button
            onClick={submit}
            disabled={!folder}
            className="mt-4 w-full py-3 rounded-xl bg-[#5b5ef4] hover:bg-[#4748d4] disabled:opacity-40 disabled:cursor-not-allowed text-white font-semibold text-sm transition-colors"
          >
            Get Started →
          </button>
        </div>
